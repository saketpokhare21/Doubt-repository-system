...
<div class= "w3-container w3-card w3-white w3-round w3-margin">
    ...
    <div class="w3-container w3-card w3-white w3-round w3-margin">
    	...
    	<%
			...
			String sql="select name, post_desc, post_id, post_img from doubt_table, user_login where user_login.prn_no = doubt_table.prn_no and subject_id = 2 order by post_id desc";
