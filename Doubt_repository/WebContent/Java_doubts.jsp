...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align w3-large">
  ...
  <a href="login.jsp" class="w3-bar-item w3-button w3-hide-small w3-right w3-padding-large w3-hover-white" title="My Account">LOGOUT
...
<div class= "w3-container w3-card w3-white w3-round w3-margin">
    ...
    <div class="w3-container w3-card w3-white w3-round w3-margin">
    	...
    	<%
			...
			String sql="select name, post_desc, post_id, post_img from doubt_table, user_login where user_login.prn_no = doubt_table.prn_no and subject_id = 1 order by post_id desc";
		...
		%>
				...
				<div class="w3-container w3-card w3-white w3-round w3-margin">
						...
						<form action="CommentController" method="post">
							<br> <input type="text" name="comment" size="80"><br>
							<br>
						...
						<%
							try
							{
								connection = DriverManager.getConnection(connectionUrl, userid, password);
								statement=connection.createStatement();
								String commentSql = "SELECT name, comments FROM comments_table, user_login WHERE comments_table.prn_no = user_login.prn_no and post_id="+resultSet.getInt("post_id")+"";				
								resultset1 = statement.executeQuery(commentSql);
								while(resultset1.next()){
						%>
						
									<div class="w3-container w3-card w3-white w3-round w3-margin">
										<h4><%=resultset1.getString("name") %></h4>
